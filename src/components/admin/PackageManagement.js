...
export default function PackageManagement() {
    ...
    const handleEdit = () => {
        ...
        if (packages.some(packages => packages.package_name.toLowerCase() === trimmedPackageName.toLowerCase() && packages.id !== selectedPackage.id)) {
        ...
        if (selectedPackage.price <= 1000000) {
            toast.error("Price must be greater than 1,000,000 VND.", { autoClose: 1500 });
            return;
        }

        if (packages.some(packages => packages.month == monthPackage && packages.id !== selectedPackage.id)) {
            toast.error("A package with the same month already exists.", { autoClose: 1500 });
            return;
        }
    ...
    const paginatedPackages = filteredPackages.slice(page * itemsPerPage, (page + 1) * itemsPerPage);
                        ...
                        <Grid item xs={3} md={3} >
                            ...
                            >
                                ...
                                <Tab
                                    label="PROCESSING"
                                    sx={{
                                        backgroundColor: storePackagesPage === true ? "#ff469e" : "#fff4fc",
                    ...
                    <Grid container spacing={2} direction={"row"}>
                        ...
                        <Grid item xs={7} md={7}>
                            <Grid container spacing={1}>
                                ...
                                <Grid item xs={2} md={2} container justifyContent="space-between">
                                    <FormControl
                                        sx={{
                                            width: '170px',
                                            border: '1px solid #ff469e',
                                    ...
                                    >
                                        <InputLabel
                                            ...
                                            shrink
                                            style={{ fontWeight: "bold", color: "#ff469e", fontSize: "1.1rem", }}
                                        >
                                            Month
                                        </InputLabel>
                                        <Select
                                ...
                                <Grid item xs={5} md={5}>
                                    <Card sx={{
                                        ...
                                        <Typography sx={{ fontWeight: "bold", fontSize: "17px", marginBottom: "2px", textAlign: "center", color: "#ff469e" }}>
                                            Monthly Revenue
                                        </Typography>
                                        <Typography sx={{ fontWeight: "bold", marginBottom: "2px", textAlign: "center" }}>
