...
export default function HomePage() {
  ...
  const fetchData = async () => {
    try {
      const [ageRes, brandRes, categoryRes, productRes, storeRes] = await Promise.all([
        allAgeApi(),
        allBrandApi(),
        allCategorytApi(),
        allProductApi(),
